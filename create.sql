...
DROP TABLE IF EXISTS vaccine_reacts_to_pathology;
DROP TABLE IF EXISTS citizen_belogs_to_pathology_group;
...
CREATE TABLE vaccine_reacts_to_pathology (
    vaccine_id INTEGER,
    pathology_id INTEGER,
    CONSTRAINT vaccine_reacts_to_pathology_pk PRIMARY KEY (vaccine_id, pathology_id),
    CONSTRAINT vaccine_reacts_to_pathology_vaccine_fk FOREIGN KEY (vaccine_id) REFERENCES vaccine ON DELETE CASCADE,
    CONSTRAINT vaccine_reacts_to_pathology_pathology_fk FOREIGN KEY (pathology_id) REFERENCES pathology ON DELETE CASCADE
);
...
CREATE TABLE citizen_belogs_to_pathology_group (
    citizen_id INTEGER,
    pathology_group_id INTEGER,
    CONSTRAINT citizen_has_pathology_pk PRIMARY KEY (citizen_id, pathology_group_id),
    CONSTRAINT citizen_has_pathology_citizen_fk FOREIGN KEY (citizen_id) REFERENCES citizen ON DELETE CASCADE,
    CONSTRAINT citizen_has_pathology_pathology_group_fk FOREIGN KEY (pathology_group_id) REFERENCES pathology_group ON DELETE CASCADE
);
...
CREATE TABLE delivery (
    ...
    CONSTRAINT delivery_distribution_center_fk FOREIGN KEY (distribution_centre_id) REFERENCES distribution_centre ON DELETE CASCADE,
